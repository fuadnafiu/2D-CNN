...
def main():
    ...
    for img_path in samples:
        ...
        # Note: The folder name logic above is a bit fragile if folder structure changes, but works for current structure: test_another/damage vs test_another/no_damage
        
        # Better logic based on parent folder name
